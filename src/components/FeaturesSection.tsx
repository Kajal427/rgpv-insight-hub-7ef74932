...
const FeatureCard = ({ feature, index }: { feature: typeof features[0]; index: number }) => {
  ...
  return (
    <div
      ref={ref}
      className={`group relative bg-card rounded-2xl p-6 border border-border overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-lg hover:border-primary/40 ${
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className="font-display text-base font-semibold mb-1.5 text-card-foreground">{feature.title}</h3>
    ...
    <section id="features" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          <span className="inline-block text-xs font-semibold tracking-widest uppercase text-primary mb-3">What We Offer</span>
          <h2 className="font-display text-3xl sm:text-4xl font-bold mb-3 text-foreground">Key Features</h2>
