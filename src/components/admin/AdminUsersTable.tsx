...
export const AdminUsersTable = ({ profiles, roles, onAddAdmin, onRemoveRole }: AdminUsersTableProps) => {
                ...
                <tr key={p.id} className="border-b border-[hsl(230,20%,16%)] hover:bg-[hsl(240,50%,55%,0.04)] transition-colors">
                  ...
                  <td className="py-3 px-4">
                    {!userRole ? (
                      ...
                      <Button size="sm" variant="ghost" className="gap-1 text-xs text-red-400 hover:bg-red-500/10 h-7" onClick={() => onRemoveRole(userRole.id)}>
