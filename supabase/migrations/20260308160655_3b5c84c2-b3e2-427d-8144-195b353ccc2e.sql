...
-- Admin function to get all profiles (security definer to bypass profiles RLS)
...
-- Admin function to get all activity logs
CREATE OR REPLACE FUNCTION public.admin_get_all_activity()
